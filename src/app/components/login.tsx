        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="space-y-2">
            <input
              ...
              className={`w-full bg-[#F8FBFF] rounded-xl px-4 py-3 text-sm border ${isSubmitted && errors.credential ? "border-red-500" : "border-transparent"} focus:outline-none`}
              placeholder="Email hoặc số điện thoại"
            />
            {isSubmitted && errors.credential && <p className="text-red-500 text-xs mt-1">{errors.credential}</p>}
          </div>
          ...
          <div className="space-y-2">
            <div className="relative">
              <input
                ...
                className={`w-full bg-[#F8FBFF] rounded-xl px-4 py-3 text-sm border ${isSubmitted && errors.password ? "border-red-500" : "border-transparent"} focus:outline-none`}
          ...
          <p className="text-right text-cyan-600 ">Quên mật khẩu</p>
