...
const UserProfile = () => {
  ...
  return (
    <>
      <ProfileEdit showModalEditProfile={showModalEditProfile} setShowModalEditProfile={setShowModalEditProfile} />
      <Container className="max-w-lg mx-auto !px-20 py-5">
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="flex flex-col">
            ...
            <input type="text" className="border rounded px-3 py-2 w-full" value={user.dateOfBirth ? new Date(user.dateOfBirth).toLocaleDateString() : "Thêm thông tin"} readOnly />
          </div>
        </div>
        <div className="mt-6 flex justify-end">
          <div className="relative inline-flex items-center justify-start px-5 py-2 bg-cyan-500 text-white font-medium rounded-lg shadow-lg transition duration-300 hover:text-transparent active:translate-x-1 active:translate-y-1 active:shadow-md" onClick={handleEdit}>
            Chỉnh sửa thông tin
